...
Swallowプロジェクト，特にTSUBAMEでの評価作業に特化したマニュアルはリンク先を参照してください．Ref. [TSUBAME4を用いた評価方法](./README_t4_a3_lcl.md)
...
* HumanEval: `swallow|humaneval`
* HumanEval+: `swallow|humanevalplus`
